...
### 对手论证证明连通性下界
我们可以对一个有N个点的图做如下操作，将它分为两个子集，一个为n大小U1，另一个为m大小U2，算法如果在询问是否存在边u,w(u属于U1,w属于U2)之前算法检查出图是连通的，则我们将图变为U1，U2中全联通,U1和U2中所有有边都打断；或者算法这时候检查出图是不联通的，则将u,w联通起来，U1和U2都联通起来，那么我们发现这两种情况，都至少要再进行n*m次询问边是否存在，而我们要让询问次数最多，即输入最差，则要使得n=m,则不难得到算法的下界了
# 问题的分类
